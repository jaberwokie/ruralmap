  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "staffing-low": "hsl(var(--staffing-low))",
        "staffing-medium": "hsl(var(--staffing-medium))",
        "staffing-high": "hsl(var(--staffing-high))",
        "engagement-early": "hsl(var(--engagement-early))",
        "engagement-watch": "hsl(var(--engagement-watch))",
        "engagement-gap": "hsl(var(--engagement-gap))",
        "utilization-low": "hsl(var(--utilization-low))",
