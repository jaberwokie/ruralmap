...
export const operationalTags: OperationalTag[] = [
  ...
  { entityId: 'rs-27',  entityType: 'ruralService', isNevadaMedicaidParticipating: null, verificationStatus: 'needs_verification', verificationSource: 'No site-level confirmation', verificationDate: '2026-04', notes: 'Battle Born Counseling Center — independent SU provider, Carson City' },
  { entityId: 'rs-28',  entityType: 'ruralService', isNevadaMedicaidParticipating: null, verificationStatus: 'needs_verification', verificationSource: 'No site-level confirmation', verificationDate: '2026-04', notes: 'Vitality Carson City (Residential) — SU residential, needs enrollment check' },
  { entityId: 'rs-29',  entityType: 'ruralService', isNevadaMedicaidParticipating: null, verificationStatus: 'needs_verification', verificationSource: 'No site-level confirmation', verificationDate: '2026-04', notes: 'Community Counseling Center — Carson City, nonprofit SU provider' },
  { entityId: 'rs-30',  entityType: 'ruralService', isNevadaMedicaidParticipating: null, verificationStatus: 'needs_verification', verificationSource: 'No site-level confirmation', verificationDate: '2026-04', notes: 'The Life Change Center — Carson City, SU provider' },
  { entityId: 'rs-32',  entityType: 'ruralService', isNevadaMedicaidParticipating: null, verificationStatus: 'needs_verification', verificationSource: 'No site-level confirmation', verificationDate: '2026-04', notes: 'Connections Behavioral Health Center — Carson City, MH provider' },
  { entityId: 'rs-33',  entityType: 'ruralService', isNevadaMedicaidParticipating: null, verificationStatus: 'needs_verification', verificationSource: 'No site-level confirmation', verificationDate: '2026-04', notes: 'Serenity Mental Health — Carson City, MH provider' },
  { entityId: 'rs-50',  entityType: 'ruralService', isNevadaMedicaidParticipating: null, verificationStatus: 'needs_verification', verificationSource: 'No site-level confirmation', verificationDate: '2026-04', notes: 'New Frontier Treatment Center — Fallon, SU provider' },
  ...
  { entityId: 'rs-66',  entityType: 'ruralService', isNevadaMedicaidParticipating: null, verificationStatus: 'needs_verification', verificationSource: 'No site-level confirmation', verificationDate: '2026-04', notes: 'Community Counseling Center Douglas — Gardnerville, MH provider' },
  ...
  { entityId: 'rs-83',  entityType: 'ruralService', isNevadaMedicaidParticipating: null, verificationStatus: 'needs_verification', verificationSource: 'No site-level confirmation', verificationDate: '2026-04', notes: 'Vitality Unlimited - Vitality Center — Elko, SU provider' },
  { entityId: 'rs-84',  entityType: 'ruralService', isNevadaMedicaidParticipating: null, verificationStatus: 'needs_verification', verificationSource: 'No site-level confirmation', verificationDate: '2026-04', notes: 'Vitality Integrated Programs (VIP) — Elko, MH provider' },
  ...
  { entityId: 'rs-145', entityType: 'ruralService', isNevadaMedicaidParticipating: null, verificationStatus: 'needs_verification', verificationSource: 'No site-level confirmation', verificationDate: '2026-04', notes: 'Rural Nevada Counseling - Dayton — SU provider' },
  { entityId: 'rs-146', entityType: 'ruralService', isNevadaMedicaidParticipating: null, verificationStatus: 'needs_verification', verificationSource: 'No site-level confirmation', verificationDate: '2026-04', notes: 'Rural Nevada Counseling - Yerington — MH provider' },
];
