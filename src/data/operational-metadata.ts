...
export const operationalTags: OperationalTag[] = [
  ...
  { entityId: 'rs-51',  entityType: 'ruralService', isNevadaMedicaidParticipating: null, verificationStatus: 'needs_verification', verificationSource: 'No site-level confirmation', verificationDate: '2026-04', notes: 'Fallon Family Wellness Center (MH) — Fallon, MH provider', verificationNotes: 'Searched Nevada DPBH BH Provider Directory on 2026-04-09. No listing found for this entity name or address.' },
  ...
  { entityId: 'rs-82',  entityType: 'ruralService', isNevadaMedicaidParticipating: null, verificationStatus: 'needs_verification', verificationSource: 'No site-level confirmation', verificationDate: '2026-04', notes: 'Ruby Mountain Recovery — Elko, SU provider', verificationNotes: 'Searched Nevada DPBH BH Provider Directory on 2026-04-09. No listing found for this entity name or address.' },
