...
export const operationalTags: OperationalTag[] = [
  ...
  { entityId: 't1',  entityType: 'facility', isNevadaMedicaidParticipating: null,  verificationStatus: 'needs_verification', verificationSource: 'Not yet verified', verificationDate: '2026-04', notes: 'Beautiful Mind of Las Vegas LLC — needs individual verification', verificationNotes: 'Searched Nevada DPBH BH Provider Directory on 2026-04-09. No listing found for this entity name or address.' },
