...
export const localTransitProviders: LocalTransitProvider[] = [
  ...
  },
  {
    ...
    type: 'local_transit_provider',
    zoneIds: ['ltz-pleasant-senior-winnemucca'],
    serviceType: 'demand_response',
    supportLevel: 'limited_community_transit',
    source: 'NDOT',
    coverageConfidence: 'approximate',
  ...
  },
  {
    ...
    type: 'local_transit_provider',
    zoneIds: ['ltz-lyon-hs-yerington', 'ltz-lyon-hs-dayton-fernley'],
    serviceType: 'demand_response',
    supportLevel: 'limited_community_transit',
    source: 'NDOT',
    coverageConfidence: 'approximate',
  ...
  },
  {
    ...
    type: 'local_transit_provider',
    zoneIds: ['ltz-nye-senior-tonopah'],
    serviceType: 'demand_response',
    supportLevel: 'limited_community_transit',
    source: 'NDOT',
    coverageConfidence: 'approximate',
  ...
  },
  {
    ...
    type: 'local_transit_provider',
    zoneIds: ['ltz-pyramid-lake-nixon'],
    serviceType: 'demand_response',
