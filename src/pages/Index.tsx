    ...
    <div className="relative flex flex-col md:flex-row h-screen w-screen overflow-hidden bg-background">
      ...
      */}
      ...
      >
        ...
        <div
          className={`${desktopSidebarCollapsed && !isMobileLayout ? 'hidden' : 'flex flex-col flex-1 min-h-0 w-full overflow-y-auto'}${isTabletLayout ? ' text-[13px] [&_*]:tracking-tight pb-8' : ''}`}
