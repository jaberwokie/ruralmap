...
const Sidebar = ({
  ...
  const [coreMapOpen, toggleCoreMap, setCoreMapOpen] = usePersistToggle('sidebar_layer_core', false);
  ...
  return (
    <div data-tutorial="sidebar" className="relative flex h-full w-full flex-col bg-card shadow-[var(--shadow-panel)] border-r border-[hsl(var(--brand-health)/0.3)]">
      ...
      {/* Filters relocated into the detail panel (county / address) as
          "Refine Results" — see src/components/map/RefineResultsPanel.tsx. */}
